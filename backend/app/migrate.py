...
# Якщо БД лежить поруч з migrate.py — шукаємо там теж
...
# ─── 4. Нові таблиці (якщо не існують) ───────────────────────────────────────
...
# ─── 5. Заповнюємо leaderboard з існуючих users ──────────────────────────────
...
# ─── 6. Хешуємо паролі які ще plain-text ─────────────────────────────────────
...
try:
    ...
    for u in users_pw:
        pw = u["password"]
        if pw and not pw.startswith("$2"):   # ще не bcrypt
